...
function preload() {
  ...
  bgMusic = loadSound('assets/bgm.mp3'); // 背景音樂，請將檔案命名為 bgm.mp3
  answerMusic = loadSound('assets/answer.mp3'); // 問答音樂
  fightMusic = loadSound('assets/fight.mp3');   // 戰鬥音樂
  correctSound = loadSound('assets/correct.mp3'); // 答對音效
  wrongSound = loadSound('assets/incorrect.mp3'); // 答錯音效
  switchSound = loadSound('assets/switch.mp3');   // 交換音效
  dropSound = loadSound('assets/drop.mp3');       // 掉落音效
  zzzSound = loadSound('assets/zzz.mp3');         // 電流音效
  alarmSound = loadSound('assets/alarm.mp3');     // 警報音效
  mjMusic = loadSound('assets/MJ.mp3');           // MJ.mp3
  tfSound = loadSound('assets/TF.mp3');           // TF.mp3
  ydSound = loadSound('assets/YD.mp3');           // YD.mp3
  // -------------------------------------------------------
}
